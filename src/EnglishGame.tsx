...
const MedievalInternetGrid = () => {
  const data = [
    ...
    { name: "brigant", term: "hacker", category: "action", description: "pique des octets" },
    ...
    { name: "marché", term: "marketplace", category: "infra", description: "permet echange avec d'autres joueurs" },
    { name: "batisseur", term: "baie de serveur", category: "infra", description: "genere des serveur/ par tour" },
    { name: "recolteur", term: "API", category: "infra", description: "genere des octets / par tour" },
    {
      name: "bibliothèque",
